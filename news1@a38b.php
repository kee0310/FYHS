            ...
            <div class="page-content">
              ...
              <div class="col-md-8 service-box service-icon-left-more">
                ...
                <div>
                  ...
                  <div class="content" style="background: white; padding: 20px; border: 1px solid mistyrose; border-radius: 15px">
                    ...
                    <?php
                    include('connect.php');
                    $result = mysqli_query($mysqli, "SELECT * FROM wnews_img where news_id='$id' ORDER BY img_id DESC");
                    while ($row = mysqli_fetch_array($result)) {
              ...
              <div class="col-md-4">
                ...
                <div class="latest-posts" style="background: url(img/subbanner08.webp) center;">
                  ...
                  <?php
                  include('connect.php');
                  $query = "SELECT * FROM wnews WHERE news_id!='$id' ORDER BY news_date DESC LIMIT 3";
                  if ($result = $mysqli->query($query)) {
                    while ($row = mysqli_fetch_array($result)) {
                      $date = strtotime($row['news_date']);
                      $id = $row['news_id']
                ...
                <div class="latest-posts" style="background: url(img/subbanner19.webp) center;">
                  ...
                  <?php
                  include('connect.php');
                  $query = "SELECT * FROM wannouncement ORDER BY announcement_date DESC LIMIT 3";
                  if ($result = $mysqli->query($query)) {
                    while ($row = mysqli_fetch_array($result)) {
