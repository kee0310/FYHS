<!-- 
  This page are use to display more information about the school.
-->
      ...
      <div class="page-content">
        ...
        <div id="about1" align="center" style="scroll-margin-top: 80px">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <img src="img/ab03.jpg" style="width: 100%; height: auto" title="宽柔校歌">
            </div>
          </div>
        </div>
        <!-- first part end -->
        ...
        <div id="about3" align="center" style="scroll-margin-top: 80px">
          ...
          <div class="row">
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: center; margin-top: 30px">
              <img src="img/img03.jpg" style="max-width: 400px; padding: 0 20px; object-fit: cover; margin-bottom: 30px;">
              <ol class="olcards">
                <li>
                  <div class="content">
          ...
          <div class="row">
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: center;">
              <div class="counter-item col-xs-12 col-sm-3 col-md-3" style="margin-top:50px;">
                ...
                <div class="timer" id="item4" data-to="5367" data-speed="5000" style="color: #46bbec; font-family: 楷体, KaiTi;"></div>
                <h4 style="font-family: 楷体, KaiTi; font-size: 16pt;line-height: 1.6;">2023年师生人数</h4>
              </div>
              <div class="counter-item col-xs-12 col-sm-3 col-md-3" style="margin-top:50px;">
                <i class="fa fa-male" style="color: #46bbec"></i>
                <div class="timer" id="item4" data-to="9443" data-speed="5000" style="color: #46bbec; font-family: 楷体, KaiTi;"></div>
        ...
        <div id="about6" align="center" style="scroll-margin-top: 80px">
          ...
          <div class="row">
            ...
            <div class="frame">
              <img src="img/iso_cert.jpg" style="max-width: 100%" title="ISO certificate Foon Yew High School">
            </div>
          </div>
        </div>
        <!-- sixth part end -->
        ...
        <div id="about8" style="scroll-margin-top: 80px">
          ...
          <div class="row">
            ...
            <?php
            $allcourse = array("华文", "国文", "英文", "数学", "历史", "地理", "科学", "电脑", "美术", "体育", "音乐", "生活辅导", "联课活动");
