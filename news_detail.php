<!-- 
  This page are use to display the details of the news which user selected.
-->
...
<body>
  ...
  <div id="content">
    <div class="container">
      ...
      <?php
      $id = $_GET['id'];
      $query = mysqli_query($mysqli, "SELECT * FROM wnews where news_id='$id'");
      ...
      <!-- Display Post -->
      <div class="col-md-8">
        <h2 class="classic-title"><?= $row['news_title']; ?></h2>
        ...
        <div class="content" style="background: white; padding: 20px; border: 1px solid mistyrose; border-radius: 15px">
          ...
          <!-- Display Image -->
          <?php
          $result = mysqli_query($mysqli, "SELECT * FROM wnews_img where news_id='$id' ORDER BY img_name");
          while ($row = mysqli_fetch_array($result)) {
            echo '<img width="100%" src="img/news/' . $row['img_name'] . '" alt="">';
          }
          ?>
        </div><br>
      </div>
      ...
      <div class="col-md-4">
        ...
        <div class="latest-posts" style="background: url(img/subbanner08.webp) center;">
          ...
          <?php
          $query = mysqli_query($mysqli, "SELECT * FROM wnews WHERE news_id!='$id' ORDER BY news_date DESC LIMIT 3");
        ...
        <div class="latest-posts" style="background: url(img/subbanner19.webp) center;">
          ...
          <?php
          $query = mysqli_query($mysqli, "SELECT * FROM wannouncement ORDER BY announcement_date DESC LIMIT 3");
          while ($row = mysqli_fetch_array($query)) {
