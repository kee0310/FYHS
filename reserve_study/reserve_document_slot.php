...
<body>
	...
	<div style="height: 20px"></div>	
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
			<div class="panel-heading" align="center">选择时段【文件验证预约】</div>
			<div class="panel-body">
			
			<div class="form">

			<form action="reserve_document_slot_exe.php" method="post" name="login">
...
?>				
			...
			<div class="form-group">
			<input type="hidden" name="reserve6_status" value="文件验证" readonly>
			</div>
