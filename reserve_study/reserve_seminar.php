...
if (isset($_REQUEST['username'])){
	...
	$_SESSION['username'] = $username;	
				...
				echo "<meta http-equiv=REFRESH CONTENT=1;url=reserve_seminar_slot.php>";
				exit();
...
?>
	...
	<div style="height: 20px"></div>	
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-heading" align="center">升学辅导讲座预约</div>
				</div>
			</div>
					<div style="height: 20px"></div>
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			...
			<div class="panel-heading" align="center">讲座日期</div>
			<div style="height: 10px"></div>
			<ul>
			<li>20/7/2021（二）</li>
			<li>21/7/2021（三）</li>
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
			<div class="panel-heading" align="center">请正班长代表班级进行登记</div>
			<div class="panel-body">
			...
			<input class="form-control" type="text" name="username" placeholder="正班长的学号" required />
			</div>
			<div class="form-group">
			<input class="form-control" type="password" name="password" placeholder="正班长的身份证号码【 e.g: 911122012233 】" required />
			</div>
			
			<div class="form-group">
			<label>**每一天将会有 2 个时段，9.00 AM 与及 2.00 PM</label><br>
			<label>**每一个时段只能用 3 个班级预约</label>
			</div>
