		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
						<div class="login-panel panel panel-default">
							<div class="panel-heading" align="center">选择讲座时段</div>
							<div class="panel-body">

								<div class="form">

									<form action="reserve_seminar_slot_exe.php" method="post" name="login">
							...
							");
										...
										<div class="form-group">
											<input type="hidden" name="reserve6_status" value="高三讲座" readonly>
										</div>
