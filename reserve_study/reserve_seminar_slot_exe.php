...
$student_number2=$_SESSION['username'];
$reserve5_tf3 = 1 ;
mysql_query("UPDATE reserve5_shop SET reserve5_tf3='$reserve5_tf3' WHERE reserve5_name='$student_number2'");
				...
				echo "<div class='form'><div style='width: 100%' align='center'><h3>你的讲座预约时段是";
				...
				echo "<br><br><a href='http://www.fyk.edu.my' title='宽柔中学古来分校 官方网址链接'>宽柔中学古来分校 官方网址链接</a></h3></div></div>";
