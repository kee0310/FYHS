							...
							");
								...
								?>
									...
									<table style="width: 100%; font-family: 楷体, KaiTi; font-size: 16pt;line-height: 1.6;color:#222222;">
										<tbody>
											<tr>
												<td style="width: 50%;" align="right">学生编号：</td>
												<td><?php echo $row['entrance_username']; ?></td>
											</tr>
											<tr>
												<td style="width: 50%;" align="right">中文姓名：</td>
												<td><?php echo $row['entrance_chname']; ?></td>
											</tr>
											<tr>
												<td style="width: 50%" align="right">英文姓名：</td>
												<td><?php echo $row['entrance_egname']; ?></td>
											</tr>
											<tr>
												<td align="right">性别：</td>
												<td><?php echo $row['entrance_gender']; ?></td>
											</tr>
											<tr>
												<td align="right">小学：</td>
												<td><?php echo $row['entrance_schoolorg']; ?></td>
											</tr>
											<tr>
												<td align="center" colspan="2"><span style="font-weight: bold"><br><br>入学考试成绩</span></td>
											</tr>
											<tr>
												<td align="right">华文：</td>
												<td><?php echo $row['entrance_bc']; ?></td>
											</tr>
											<tr>
												<td align="right">国文：</td>
												<td><?php echo $row['entrance_bm']; ?></td>
											</tr>
											<tr>
												<td align="right">英文：</td>
												<td><?php echo $row['entrance_bi']; ?></td>
											</tr>
											<tr>
												<td align="right">数学：</td>
												<td><?php echo $row['entrance_math']; ?></td>
											</tr>
											<tr>
												<td align="right">总分：</td>
												<td><?php echo $row['entrance_total']; ?></td>
											</tr>
											<tr>
