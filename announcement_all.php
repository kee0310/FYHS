    ...
    <div class="container">
      <div class="page-content row">
        ...
        <div class="latest-posts">
          ...
          <!-- Search bar -->
          <form action="announcement_all.php#content" method="post" onclick="preventResubmitPrompt()" style="display:grid; margin-bottom: 20px;" align="center">
          ...
          <?php
          $query = mysqli_query($mysqli, "SELECT * FROM wannouncement WHERE ((announcement_title LIKE '%$search%') OR (announcement_content LIKE '%$search%')) AND (announcement_dept LIKE '%$dept%') ORDER BY announcement_date DESC, announcement_id DESC");
          ...
          ?>
            ...
            <!-- Display All Posts -->
            <div class="post-row" onclick="window.open('announcement_detail.php?id=<?= $row['announcement_id'] ?>', '_self')">
              ...
              <div style="width: 100%; padding: 10px 20px;">
                <div class="post-title">
                  <b><?= $row['announcement_title'] ?></b>
                </div>
                <div style="font-size: smaller; padding: 5px;">
                  <i class="fa fa-building"></i><?= $row['announcement_dept']; ?><br>
                  <i class="fa fa-calendar"></i><?= $row['announcement_date']; ?>&emsp;
                </div>
