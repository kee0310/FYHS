			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<?php
							...
							SELECT a.dis3_student_number,a.dis3_student_name,a.dis3_id
							FROM ddis3 a						
							WHERE a.dis3_student_number = '$id'
							ORDER BY a.dis3_id DESC LIMIT 1
							");
							while($row = mysql_fetch_array($result))
								{		

								echo '学生编号：';
								echo '<span>'.$row["dis3_student_number"].'</span>';								
								echo '&nbsp;&nbsp;&nbsp;';
								echo '学生姓名：';
								echo '<span>'.$row["dis3_student_name"].'</span>';								
								echo '&nbsp;&nbsp;&nbsp;';								
								echo '<a href="printdash3.php?id='.$row["dis3_id"].'" target="_blank" title="打印">打印</a>';
