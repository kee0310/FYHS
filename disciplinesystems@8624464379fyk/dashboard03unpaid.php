		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">训导处 - 购买物品（未付款）</div>
					...
					<?php
						    ...
						    echo '<tr>';
								...
								echo '<td><form action="changetoreturn03.php" method="post" name="login">';
								echo '<input class="form-control" type="date" name="date_paid" required />';
								echo '<input class="form-control" type="hidden" name="id" value="'.$row["dis3_id"].'" />';
								echo '<button type="submit">付款</button></form></td>';
