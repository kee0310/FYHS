    ...
    <div class="row">
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        <div class="panel panel-default" style="margin: 20px 15px;">
          <div class="panel-heading">修改资料 (最新消息)</div>

          <div class="panel-body">
            <form role="form" action="wnews_edit_exe.php" method="post">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>发布日期</label>
                  <input class="form-control" type="date" value="<?php echo $row['news_date']; ?>" name="news_date">
                </div>
                ...
                <div class="form-group">
                  <label>标题</label>
                  <input class="form-control" value="<?php echo $row['news_title']; ?>" name="news_title">
                </div>

                <div class="form-group">
                  <label>内容</label>
                  <textarea class="form-control" name="news_content" rows="10"
