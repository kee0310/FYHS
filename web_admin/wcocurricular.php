              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div type="button" class="btn btn-primary" onclick="window.open('../co-curricular_detail.php?id=<?php echo $row['co_id'] ?>', '_self')">
                        View
                      </div>
                    </td>
                    <td>
                      <a class="btn btn-primary" title="Edit" href="wcocurricular_edit.php?id=<?php echo $row['co_id'] ?>">Edit</a>
                    </td>
                    <td>
