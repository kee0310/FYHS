...
<![endif]-->
  ...
  <script type="text/javascript">
    function previewMultiple(event) {
      let gallery = document.getElementById("announcement_image");
      ...
      for (i = 0; i < gallery.files.length; i++) {
        ...
        document.getElementById("gallery").innerHTML += '<img id="img" src="' + urls + '">';
      }
    }
  </script>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row" style="margin: 20px 0">
      <div class="panel panel-default">
        <div class="panel-heading">新建资料 (活动/通知/公告)</div>

        <div class="panel-body">
          <form role="form" action="wannouncement_create_exe.php" method="post" enctype="multipart/form-data">
            <div class="col-md-6">
              <?php
              include('connect.php');
              $result = mysqli_query($conn, "SELECT announcement_id FROM wannouncement ORDER BY announcement_id DESC LIMIT 1");
              ...
              <div class="form-group">
                <label>发布日期</label>
                <input class="form-control" type="date" value="<?php echo date("Y-m-d"); ?>" name="announcement_date">
              </div>
              ...
              <div class="form-group">
                <label>标题</label>
                <input class="form-control" name="announcement_title">
              </div>
              ...
              <div class="form-group">
                <label>上传图片</label>
                <input type="file" name="file[]" onchange="previewMultiple(event)" id="announcement_image" multiple>
                <div id="gallery"></div>
              </div>
