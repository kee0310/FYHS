...
<tr>
<td align="center"><p style="line-height: 1.3;">高一实践活动课程：答辩与报告评估表 Presentation and Report Evaluation Form</p>
</td>
</tr>
</tbody>
</table>
						...
						while($row = mysql_fetch_array($result))
							{
								...
								echo '&nbsp;&nbsp;&nbsp;';
								echo 'Group Code：'.$row["group_code"].'';	
								echo '<br>';
								echo '指导老师：'.$row["apply_teacher"].'';	
								echo '<br>';
						        echo '项目名称：'.$row["apply_topic"].'';	
								echo '<br>';
...
?>
						...
						?>   
						学号：<?php echo $row['student_number']; ?>   
