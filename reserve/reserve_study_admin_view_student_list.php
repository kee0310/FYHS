			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<?php
						    ...
						    echo '<tr>';
						        echo '<td>'.$row["reserve5_name"].'</td>';							
						        echo '<td>'.$row["student_class"].'</td>';
								echo '<td>'.$row["student_name"].'</td>';
						        echo '<td>'.$row["student_password"].'</td>';

								if ($row["reserve5_tf"] == 2){
				
									echo '<td><span style="color: green">开放</span></td>';
				
								}								
								else{
				
									echo '<td><span style="color: red">关闭</span></td>';
						        ...
						        echo '<td><a class="btn btn-primary" title="Edit" href="reserve_study_admin_view_student_edit.php?id='.$row['reserve5_name'].'">Edit</a></td>';					        
