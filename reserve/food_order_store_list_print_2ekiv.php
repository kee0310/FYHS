...
<tr>
	...
	<td style="width: 10%" align="center">SEASONS豆奶</td>
	<td style="width: 10%" align="center">POKKA 绿茶</td>
	<td style="width: 10%" align="center">小麦草</td>
	<td style="width: 10%" align="center">DL cream milk</td>
	<td style="width: 10%" align="center">DL chocolate</td>
	<td style="width: 10%" align="center">MILO</td>
	<td style="width: 10%" align="center">100 Plus</td>
	<td style="width: 10%" align="center">果汁（4种）</td>
	<td style="width: 10%" align="center">GOODDAY milk</td>
	<td style="width: 10%" align="center">GOODDAY chocolate</td>
</tr>
		<?php			
			include('connect.php');
			$id=$_GET['id'];
