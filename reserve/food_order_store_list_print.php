...
<td style="width: 50%;vertical-align: top;">
						...
						<table style="width: 100%; border-collapse: collapse;" border="1" >
						    ...
						    <tr>		
								...
								<th style="font-size:12px; line-height: 1.4;width: 10%">早餐</th>
						    </tr>
							</thead>
							<tbody>
					<?php
	...
	include('connect.php');
			...
			$date=$_GET['date'];
			$result = mysql_query("
							SELECT count(a.reserve_fd3_food_id) AS abc, a.reserve_fd3_student_class
							FROM reserve_fd3 a 
							...
							WHERE a.reserve_fd3_date='$date' AND a.reserve_fd3_store='$id' AND a.reserve_fd3_ma='m'
...
<td style="width: 50%;vertical-align: top;">
						...
						<table style="width: 100%; border-collapse: collapse;" border="1" >
						    ...
						    <tr>		
						        <th style="font-size:12px; line-height: 1.4;width: 20%">班级</th>
								<th style="font-size:12px; line-height: 1.4;width: 10%">午餐</th>
						    </tr>
							</thead>
							<tbody>
					<?php
