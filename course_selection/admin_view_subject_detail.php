		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">课程资料
					<span style="float: right"><a class="btn btn-primary" title="2020上半年问卷总结" target="_blank" href="print/admin_survey_main_summary.php">2020上半年问卷总结</a></span></div>
					...
					<?php
						    ...
						    echo '<tr>';
						        ...
						        echo '<td><a target="_blank" title="学生名单" href="print/admin_class_name_list.php?id='.$row['course_id'].'">'.$row["course_title"].'</a></td>';							
								...
								echo '<td>'.$row["abc"].'</td>';								
						        echo '<td><a class="btn btn-primary" title="查看名单" href="admin_view_subject_detail_list.php?id='.$row['course_id'].'">名单</a></td>';
								echo '<td><a class="btn btn-primary" target="_blank" title="个人回馈" href="print/admin_course_survey.php?id='.$row['course_id'].'&classday='.$row['course_class_day'].'&upperlower='.$row['course_class_upperlower'].'&year='.$row['course_class_year'].'">个人回馈</a></td>';
								echo '<td><a class="btn btn-primary" target="_blank" title="打开问卷" href="print/admin_survey_summary.php?id='.$row['course_id'].'&classday='.$row['course_class_day'].'&upperlower='.$row['course_class_upperlower'].'&year='.$row['course_class_year'].'">打开问卷</a></td>';	
								}								
