			...
			<div class="col-md-4">
				<div class="panel panel-success">
					...
					<div class="panel-body" style="height: 100px">
						<p style="font-size: 18px ; font-weight: 550"><?php echo $row['course_teacher']; ?></h3>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="panel panel-success">
					...
					<div class="panel-body" style="height: 100px">
						<p><?php echo $row['course_teacher_exp11']; ?>  <?php echo $row['course_teacher_exp12'];?></p>
						<p><?php echo $row['course_teacher_exp21']; ?>  <?php echo $row['course_teacher_exp22'];?></p>
						<p><?php echo $row['course_teacher_exp31']; ?>  <?php echo $row['course_teacher_exp32'];?></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="panel panel-success">
					...
					<div class="panel-body" style="height: 100px">
					<p>人数上限： <?php echo $row['course_student_limit']; ?></p>	
			<?php } ?>
<?php
			...
			<div class="col-md-12">
				<div class="panel panel-warning">
					...
					<div class="panel-body">
						<table border="1" cellspacing="1" cellpadding="1" style="width: 100%; font-weight: 550; font-size: 18px; line-height: 35px">
						    <tbody>
	<tr>
