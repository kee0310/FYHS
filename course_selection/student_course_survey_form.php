...
<?php 
								if ($row["course_survey_q1"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q1"] == 2){echo "不认同";}
								else if ($row["course_survey_q1"] == 3){echo "普通";}
								else if ($row["course_survey_q1"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php 
								if ($row["course_survey_q2"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q2"] == 2){echo "不认同";}
								else if ($row["course_survey_q2"] == 3){echo "普通";}
								else if ($row["course_survey_q2"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php 
								if ($row["course_survey_q3"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q3"] == 2){echo "不认同";}
								else if ($row["course_survey_q3"] == 3){echo "普通";}
								else if ($row["course_survey_q3"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php 
								if ($row["course_survey_q4"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q4"] == 2){echo "不认同";}
								else if ($row["course_survey_q4"] == 3){echo "普通";}
								else if ($row["course_survey_q4"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php 
								if ($row["course_survey_q5"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q5"] == 2){echo "不认同";}
								else if ($row["course_survey_q5"] == 3){echo "普通";}
								else if ($row["course_survey_q5"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php 
								if ($row["course_survey_q6"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q6"] == 2){echo "不认同";}
								else if ($row["course_survey_q6"] == 3){echo "普通";}
								else if ($row["course_survey_q6"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php 
								if ($row["course_survey_q7"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q7"] == 2){echo "不认同";}
								else if ($row["course_survey_q7"] == 3){echo "普通";}
								else if ($row["course_survey_q7"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php  
								if ($row["course_survey_q8"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q8"] == 2){echo "不认同";}
								else if ($row["course_survey_q8"] == 3){echo "普通";}
								else if ($row["course_survey_q8"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php 
								if ($row["course_survey_q9"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q9"] == 2){echo "不认同";}
								else if ($row["course_survey_q9"] == 3){echo "普通";}
								else if ($row["course_survey_q9"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php 
								if ($row["course_survey_q10"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q10"] == 2){echo "不认同";}
								else if ($row["course_survey_q10"] == 3){echo "普通";}
								else if ($row["course_survey_q10"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
...
<input class="form-control" value="
<?php 
								if ($row["course_survey_q11"] == 1){echo "非常不认同";}						
								else if ($row["course_survey_q11"] == 2){echo "不认同";}
								else if ($row["course_survey_q11"] == 3){echo "普通";}
								else if ($row["course_survey_q11"] == 4){echo "认同";}
								else{echo "非常认同";}
						?>" readonly></div>
							...
							<div class="col-md-6">
								...
								<li>问卷完成时间：</li>
						<input class="form-control" value="<?php echo $row["course_survey_time"];?>"readonly></div>
