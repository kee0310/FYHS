			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form role="form" action="delete/admin_delete_student_account_exe.php" method="post">
						
							<div class="col-md-6">	
								<input type="hidden" name="student_id" value="<?php echo $row['student_id']; ?>" readonly>
								...
								<div class="form-group">
									<label>班级</label>
									<input class="form-control" value="<?php echo $row['student_class'];?>" name="student_class" readonly>
								</div>								
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<button type="submit" class="btn btn-primary">删除账号</button>
							</div>
