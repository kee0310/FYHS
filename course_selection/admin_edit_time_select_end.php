			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form role="form" action="edit/admin_edit_time_select_end_exe.php" method="post">
						
							<div class="col-md-6">	
								<div class="form-group">
									<label>学生选课结束时间</label></br></br>
									
									<input class="form-control" value="<?php echo $row['admin_time_select_end'];?>" name="admin_time_select_end"></br></br>
