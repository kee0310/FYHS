		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">学生问卷填写（搜索校友未完成，高二未完成，高三未完成，已完成）</div>
					...
					<?php
							...
							SELECT 
							count(case when b.course_survey_upperlower = '2' and b.course_survey_section = '2023' then 1 else null end) AS surveysum1, 
							
							a.student_number, a.student_name,a.student_class,a.student_form
							
							FROM student_detail a 
							LEFT JOIN course_survey b
						    ...
						    echo '<tr>';
								...
								echo '<td>'.$row["surveysum1"].'</td>';
								
								
								if ($row["student_form"] == 4 && $row["surveysum1"] != 1){
				
									echo "<td><span style='color: blue'>校友未完成</span></td>";
				
								}
								elseif ($row["student_form"] == 2 && $row["surveysum1"] != 1){
				
									echo "<td><span style='color: red'>高二未完成</span></td>";
				
								}
								elseif ($row["student_form"] == 3 && $row["surveysum1"] != 1){
