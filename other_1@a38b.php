...
<body>
    ...
    <div id="container">
        ...
        <div class="page-banner"
            style="background: linear-gradient(to bottom, rgba(0,0,0,0) 50%, rgba(0,0,0,1)), url(img/subbanner16.jpg) center; background-size: cover;">
            <div class="container">
                <div class="col-md-6">
                    <h2>其他</h2>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="vertical-tab" role="tabpanel">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation" class="active"><a href="#Section3" aria-controls="messages"
                                            role="tab" data-toggle="tab">宽友特讯</a></li>
                                    <li role="presentation"><a href="#Section4" aria-controls="messages" role="tab"
                                            data-toggle="tab">新闻剪报</a></li>
                                    <li role="presentation"><a href="#Section5" aria-controls="messages" role="tab"
                                            data-toggle="tab">其他刊物</a></li>
                                </ul>
                                <!-- Tab panes -->
